...
def get_app_folder_name(app_filename):
	...
	if size > 6000000:
		_input = raw_input("The app "+app_filename+" is more than 5MB do you want to continue as it'll take more time to retrive app folder name (y/n):")
		if _input.lower() == 'y':
			agree = 1
		else:
			agree = 0
...
if "ERROR" in PASSWORD:
	PASSWORD = "###"
	print "Couldn't fatch the stack password - Could be CloudWorks stack"
